      ...
      ========================================================== */}
        ...
        <div className="min-h-0 flex-1 overflow-y-auto p-4 space-y-4">
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* ======================================================
              UPPER QUERY WINDOW BOX
          ====================================================== */}
            <div className="rounded-lg border border-sat-border bg-sat-bg/80 p-3.5 space-y-3 shadow-sm">
              {/* Context line */}
            ...
            {/* ======================================================
              SUGGESTED ANALYSIS (PROMINENT UPPER WINDOW INTEGRATION)
          ====================================================== */}
            <div className="rounded-lg border border-sat-accent/20 bg-sat-accent/[0.02] p-3.5">
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center gap-1.5">
                  <Sparkles className="h-3.5 w-3.5 text-sat-accent" />

                  <span className="font-mono text-xs font-bold uppercase tracking-[0.12em] text-sat-text">
                    Suggested Analysis
                  </span>
                </div>

                <span className="font-mono text-[9px] font-bold uppercase tracking-wider text-sat-accent bg-sat-accent/10 px-2 py-0.5 rounded border border-sat-accent/20">
                  CONTEXT AWARE
                </span>
              </div>
                ...
                {suggestions.map((suggestion, index) => (
                  ...
                  >
                    <div className="flex min-w-0 items-start gap-2.5">
                      ...
                      <span className="font-sans text-[11px] leading-relaxed text-sat-muted transition-colors group-hover:text-sat-text">
                        {suggestion}
                      </span>
                    </div>
